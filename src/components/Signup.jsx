...
export default function Signup() {
    ...
    const handleSignup = (e) => {
        ...
        if(password===elementConfirmPassword.value)
        {
            const userData = {
                name: userName,
                email: email,
    ...
    return (
        <div className='login'>
            <div className='container setPaddingSignUp'>
                <form action="http://localhost:7000/api/user/signup" method='post' onSubmit={handleSignup}>
                    {/* <h2>Add Note</h2>
                    <div className="mb-3">
                    ...
                    <div className="loginBox boxColor">
                        ...
                        <div className='my-4 px-2 pe-4'>
                            <button style={{ height: "50px", width: "100%", fontSize: "18px" }} type="submit" className="btn btn-light mx-2">Sign up</button>
                        </div>
                        <div className='text-center'>
                            <p>Already have an account? <Link className='signupLink' style={{ cursor: "pointer" }} to="/login">Log in</Link></p>
                        </div>
                    </div>
                </form>
            </div>
