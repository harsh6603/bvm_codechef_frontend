                ...
                <form onSubmit={handleLogIn}>
                    ...
                    <div className="loginBox boxColor">
                        ...
                        <div className='my-4 px-2 pe-4'>
                            <button style={{height:"50px",width:"100%",fontSize:"18px"}} type="submit" className="btn btn-light mx-2">Log in</button>
                        </div>
                        <div className='text-center'>
                            <p>Don&lsquo;t have an account? <Link className='signupLink' style={{ cursor: "pointer" }} to="/signup">Sign up</Link></p>
                        </div>
                    </div>
                </form>
            </div>
